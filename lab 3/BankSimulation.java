...
class BankSimulation extends Simulation {
  ...
  public BankSimulation(Scanner sc) { 
    ...
    int maxLengthOfCounterQueue = sc.nextInt();
    int maxLengthOfBankQueue = sc.nextInt();

    this.bank = new Bank(numOfCounters, maxLengthOfCounterQueue, maxLengthOfBankQueue);
